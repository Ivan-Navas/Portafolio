...
import { BiLogoGithub, BiLogoLinkedinSquare, BiLogoWhatsapp } from "react-icons/bi";
...
function TopBar () {
  return (
    <div className="w-full h-[103px] bg-[#FF5943] flex px-[100px] pt-[35px] fixed">
      ...
      <div className="w-full h-[68px] border border-white rounded-e-[16px] flex items-center justify-between">
        <div className="flex">
